...
- `blackjack_test.go` — unit tests for betting clamps, insurance offer/settlement/accuracy, double, split (including split Aces), count toggle, bankroll math on win/push/lose, game-over on bankroll depletion.
